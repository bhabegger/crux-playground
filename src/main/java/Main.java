...
public class Main {
    ...
    public static void main(String[] args) throws Exception {
        ...
        Callable fn = (Callable) callClojure("main", "create-hello-fn");
        System.out.println("fn says " + fn.call());

        // Clojure can implement interfaces
        FileFilter filter = (FileFilter) callClojure("main", "create-never-filter");
        System.out.println("file filter returns " + filter.accept(new File("canttouchthis")));

        // Clojure can extend classes
        Object o = callClojure("main", "create-timestamped-object");
